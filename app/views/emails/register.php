    ...
    <table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="#D5DCE6">
        ...
        <tr>
            <td align="center">
                <table width="600" cellpadding="0" align="center" cellspacing="0" border="0" bgcolor="#F8F8F8" class="container600">
                    <tr>
                        <td style="line-height: 25px;"><img src="http://www.cloudtub.com/coming-soon/cr/top-header-bg.png" style="display: block; width: 600px; max-height: 5px;" width="600" height="25" border="0" alt="" class="top-bg" /></td><!-- ============ header =========== -->
                    </tr>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <table border="0" align="left" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="logo">
                                                        <tr>
                                                            <td align="center"><a href="http://www.cloudtub.com" style="display: block; width: 147px; height: 30px; border-style: none !important; border: 0 !important;text-decoration:none;color:rgb(72, 130, 206);font-family: Rochester, cursive;font-size:35px;font-weight:300;">Cloudtub</a></td>
                                                        </tr>
                                                    </table>
                                                        ...
                                                        <tr>
                                                            <td align="center" mc:edit="view-online" style="font-size: 13px; font-family: Helvetica, Arial, sans-serif;">
                                                                <table border="0" cellpadding="0" cellspacing="0" class="date">
                                                                    <tr>
                                                                        <td mc:edit="online" style="color: #9099a6; font-size: 14px; font-family: Noto Sans, Arial, sans-serif;" class="view-online"><a href="" style="color: #4882ce; text-decoration: none;">Registration Successful</a></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                    ...
                    <tr mc:repeatable="">
                        <td>
                            <table width="600" cellpadding="0" align="center" cellspacing="0" border="0" class="container600">
                                <tr>
                                    <td style="line-height: 3px;" class="divider">
                                        <hr style="border: 0;height: 1px; border-top: 1px solid rgba(0, 0, 0, 0.1); border-bottom: 1px solid rgba(255, 255, 255, 0.3);" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr mc:repeatable="">
                        <td align="center">
                            <table width="600" cellpadding="0" align="center" cellspacing="0" border="0" class="container600">
                                <tr>
                                    <td align="center" class="main-image"><img editable="true" mc:edit="main-image" src="http://www.cloudtub.com/coming-soon/cr/main-image.png" style="display: block; width: 560px; height: 296px;" width="560" height="296" border="0" alt="main image" /></td>
                                </tr>
                            </table>
                        </td>
                    </tr><!--============ end main image ===========-->
                                ...
                                <tr>
                                    <td align="center">
                                        <table border="0" width="520" align="center" cellpadding="0" cellspacing="0" class="container560">
                                            <tr>
                                                <td align="center" mc:edit="main-header" style="color: #6c7480; font-size: 25px; font-family: Noto Sans, Arial, sans-serif;" class="main-header">Dear <?php echo $name; ?><br />
                                                <br />
                                            ...
                                            <tr>
                                                ...
                                                <h2>Verify Your Account Using this Link :</h2><a href="http://www.cloudtub.com/verify/<?php echo $email.'/'.$code; ?>">http://www.cloudtub.com/verify/<?php echo $email.'/'.$code; ?></a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                    ...
                    <tr mc:repeatable="">
                        <td mc:edit="main-subheader" style="color: #6c7480; font-size: 14px; font-family: PT Sans, Arial, sans-serif; line-height: 36px;" class="main-subheader" align="center">
                            <h3>If you are still having problems signing up, please Contact Us at contact@cloudtub.com<br />
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <table border="0" align="center" cellpadding="0" cellspacing="0" class="website">
                                                        <tr>
                                                            <td align="center"><a href="http://www.cloudtub.com" style="display: block; width: 147px; height: 30px; border-style: none !important; border: 0 !important;text-decoration:none;color:rgb(72, 130, 206);font-family: Rochester, cursive;font-size:30px;font-weight:300;">Cloudtub</a></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
        ...
        <tr>
            <td align="center">
                <table width="600" cellpadding="0" align="center" cellspacing="0" border="0" class="container600">
                    <tr>
                        <td align="center" style="line-height: 35px;"><img src="http://www.cloudtub.com/coming-soon/cr/footer-shadow.png" style="display: block; width: 600px; height: 35px;" width="600" height="35" border="0" class="bottom-shadow" /></td>
                    </tr>
                </table>
            </td>
        </tr>
        ...
        <tr>
            <td>
                <table width="600" cellpadding="0" align="center" cellspacing="0" border="0" class="container600">
                    ...
                    <tr>
                        <td align="center" mc:edit="copy" style="color: #9da5b0; font-size: 14px; font-family: PT Sans, Arial, sans-serif;" class="unsubscribe">Copyright © Cloudtub 2012-2013.</td>
                    </tr>
