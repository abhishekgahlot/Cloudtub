                ...
                <table width="600" cellpadding="0" align="center" cellspacing="0" border="0" bgcolor="#F8F8F8" class="container600">
                                                        ...
                                                        <tr>
                                                            <td align="center" mc:edit="view-online" style="font-size: 13px; font-family: Helvetica, Arial, sans-serif;">
                                                                <table border="0" cellpadding="0" cellspacing="0" class="date">
                                                                    <tr>
                                                                        <td mc:edit="online" style="color: #9099a6; font-size: 14px; font-family: Noto Sans, Arial, sans-serif;" class="view-online"><a href="" style="color: #4882ce; text-decoration: none;">Reset Password</a></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                ...
                                <tr>
                                    <td align="center">
                                        <table border="0" width="520" align="center" cellpadding="0" cellspacing="0" class="container560">
                                            <tr>
                                                <td align="center" mc:edit="main-header" style="color: #6c7480; font-size: 20px; font-family: Noto Sans, Arial, sans-serif;" class="main-header">Dear <?php echo $name; ?><br />
                                                <br />
                                                <p> You just requested for a password reset.Please go to the following page and choose a new password<br/> <a href="http://www.cloudtub.com/resetpass/<?php echo $email.'/'.$code; ?>">
                                                http://www.cloudtub.com/resetpass/<?php echo $email.'/'.$code; ?></a><br/>
                                                 </p></td>
                                            </tr>
                    ...
                    <tr mc:repeatable="">
                        <td mc:edit="main-subheader" style="color: #6c7480; font-size: 14px; font-family: PT Sans, Arial, sans-serif; line-height: 36px;" class="main-subheader" align="center">
                            <h3>If you didn't requested Password Reset,Just Ignore this mail.<br/>For more info please Contact Us at contact@cloudtub.com<br />
                            Have A Great Day</h3>
                        </td>
                    </tr>
